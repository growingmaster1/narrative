...
public class SmartEntity : GameEntity
{
    ...
    public void SetState(string stateTechName)
    {
        ...
        if(statePlayer != null && SoundingManager.instance.states.ContainsKey(stateTechName) && SoundingManager.instance.states[stateTechName].techName == statePlayer.techName)
        {
            return;
        }
        ...
        atFlow = SoundingManager.instance.PutState(entityName, stateTechName) ?? null;
    }
