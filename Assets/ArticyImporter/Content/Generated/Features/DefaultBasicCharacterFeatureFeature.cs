...
namespace Articy.Littletown.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Littletown.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.Littletown.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
        ...
        {
            Articy.Littletown.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.Littletown.Features.DefaultBasicCharacterFeatureFeature();
