...
namespace Articy.Littletown.Features
{
    ...
    public class DefaultExtendedCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Littletown.Features.DefaultExtendedCharacterFeatureFeature newClone = ((Articy.Littletown.Features.DefaultExtendedCharacterFeatureFeature)(aClone));
        ...
        {
            Articy.Littletown.Features.DefaultExtendedCharacterFeatureFeature clone = new Articy.Littletown.Features.DefaultExtendedCharacterFeatureFeature();
